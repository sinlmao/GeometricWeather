package wangdaye.com.geometricweather.model.database.entity;
...
public class WeatherEntity {
    ...
    public String dayExchangeTimes_1;
    public String dayExchangeTimes_2;
    public String dayExchangeTimes_3;
    public String dayExchangeTimes_4;
    public String dayExchangeTimes_5;
    ...
    public String nightExchangeTimes_1;
    public String nightExchangeTimes_2;
    public String nightExchangeTimes_3;
    public String nightExchangeTimes_4;
    public String nightExchangeTimes_5;
    ...
    @Generated(hash = 1763822267)
    public WeatherEntity(Long id, String location, String refreshTime, String date,
            String moon, String week, String weatherNow, int tempNow, String airNow,
            String windDirNow, String windLevelNow, String dates_1, String dates_2,
            String dates_3, String dates_4, String dates_5, String weeks_1,
            String weeks_2, String weeks_3, String weeks_4, String weeks_5,
            String dayWeathers_1, String dayWeathers_2, String dayWeathers_3,
            String dayWeathers_4, String dayWeathers_5, int dayTemps_1,
            int dayTemps_2, int dayTemps_3, int dayTemps_4, int dayTemps_5,
            String dayWindDirs_1, String dayWindDirs_2, String dayWindDirs_3,
            String dayWindDirs_4, String dayWindDirs_5, String dayWindLevels_1,
            String dayWindLevels_2, String dayWindLevels_3, String dayWindLevels_4,
            String dayWindLevels_5, String dayExchangeTimes_1,
            String dayExchangeTimes_2, String dayExchangeTimes_3,
            String dayExchangeTimes_4, String dayExchangeTimes_5,
            String nightWeathers_1, String nightWeathers_2, String nightWeathers_3,
            String nightWeathers_4, String nightWeathers_5, int nightTemps_1,
            int nightTemps_2, int nightTemps_3, int nightTemps_4, int nightTemps_5,
            String nightWindDirs_1, String nightWindDirs_2, String nightWindDirs_3,
            String nightWindDirs_4, String nightWindDirs_5,
            String nightWindLevels_1, String nightWindLevels_2,
            String nightWindLevels_3, String nightWindLevels_4,
            String nightWindLevels_5, String nightExchangeTimes_1,
            String nightExchangeTimes_2, String nightExchangeTimes_3,
            String nightExchangeTimes_4, String nightExchangeTimes_5,
            String hours_1, String hours_2, String hours_3, String hours_4,
            String hours_5, String hours_6, String hours_7, String hours_8,
            int hourlyTemps_1, int hourlyTemps_2, int hourlyTemps_3,
            int hourlyTemps_4, int hourlyTemps_5, int hourlyTemps_6,
            int hourlyTemps_7, int hourlyTemps_8, float hourlyPops_1,
            float hourlyPops_2, float hourlyPops_3, float hourlyPops_4,
            float hourlyPops_5, float hourlyPops_6, float hourlyPops_7,
            float hourlyPops_8, String winds_1, String winds_2, String pms_1,
            String pms_2, String hums_1, String hums_2, String uvs_1, String uvs_2,
            String dresses_1, String dresses_2, String colds_1, String colds_2,
            String airs_1, String airs_2, String washCars_1, String washCars_2,
            String sports_1, String sports_2) {
        this.id = id;
        ...
        this.dayExchangeTimes_1 = dayExchangeTimes_1;
        this.dayExchangeTimes_2 = dayExchangeTimes_2;
        this.dayExchangeTimes_3 = dayExchangeTimes_3;
        this.dayExchangeTimes_4 = dayExchangeTimes_4;
        this.dayExchangeTimes_5 = dayExchangeTimes_5;
        ...
        this.nightExchangeTimes_1 = nightExchangeTimes_1;
        this.nightExchangeTimes_2 = nightExchangeTimes_2;
        this.nightExchangeTimes_3 = nightExchangeTimes_3;
        this.nightExchangeTimes_4 = nightExchangeTimes_4;
        this.nightExchangeTimes_5 = nightExchangeTimes_5;
    ...
    public static WeatherEntity build(Weather weather) {
        ...
        entity.dayExchangeTimes_1 = weather.dailyList.get(0).exchangeTimes[0];
        entity.dayExchangeTimes_2 = weather.dailyList.get(1).exchangeTimes[0];
        entity.dayExchangeTimes_3 = weather.dailyList.get(2).exchangeTimes[0];
        entity.dayExchangeTimes_4 = weather.dailyList.get(3).exchangeTimes[0];
        entity.dayExchangeTimes_5 = weather.dailyList.get(4).exchangeTimes[0];
        ...
        entity.nightExchangeTimes_1 = weather.dailyList.get(0).exchangeTimes[1];
        entity.nightExchangeTimes_2 = weather.dailyList.get(1).exchangeTimes[1];
        entity.nightExchangeTimes_3 = weather.dailyList.get(2).exchangeTimes[1];
        entity.nightExchangeTimes_4 = weather.dailyList.get(3).exchangeTimes[1];
        entity.nightExchangeTimes_5 = weather.dailyList.get(4).exchangeTimes[1];
    ...
    public String getDayExchangeTimes_1() {
        return this.dayExchangeTimes_1;
    }

    public void setDayExchangeTimes_1(String dayExchangeTimes_1) {
        this.dayExchangeTimes_1 = dayExchangeTimes_1;
    }

    public String getDayExchangeTimes_2() {
        return this.dayExchangeTimes_2;
    }

    public void setDayExchangeTimes_2(String dayExchangeTimes_2) {
        this.dayExchangeTimes_2 = dayExchangeTimes_2;
    }

    public String getDayExchangeTimes_3() {
        return this.dayExchangeTimes_3;
    }

    public void setDayExchangeTimes_3(String dayExchangeTimes_3) {
        this.dayExchangeTimes_3 = dayExchangeTimes_3;
    }

    public String getDayExchangeTimes_4() {
        return this.dayExchangeTimes_4;
    }

    public void setDayExchangeTimes_4(String dayExchangeTimes_4) {
        this.dayExchangeTimes_4 = dayExchangeTimes_4;
    }

    public String getDayExchangeTimes_5() {
        return this.dayExchangeTimes_5;
    }

    public void setDayExchangeTimes_5(String dayExchangeTimes_5) {
        this.dayExchangeTimes_5 = dayExchangeTimes_5;
    }
    ...
    public String getNightExchangeTimes_1() {
        return this.nightExchangeTimes_1;
    }

    public void setNightExchangeTimes_1(String nightExchangeTimes_1) {
        this.nightExchangeTimes_1 = nightExchangeTimes_1;
    }

    public String getNightExchangeTimes_2() {
        return this.nightExchangeTimes_2;
    }

    public void setNightExchangeTimes_2(String nightExchangeTimes_2) {
        this.nightExchangeTimes_2 = nightExchangeTimes_2;
    }

    public String getNightExchangeTimes_3() {
        return this.nightExchangeTimes_3;
    }

    public void setNightExchangeTimes_3(String nightExchangeTimes_3) {
        this.nightExchangeTimes_3 = nightExchangeTimes_3;
    }

    public String getNightExchangeTimes_4() {
        return this.nightExchangeTimes_4;
    }

    public void setNightExchangeTimes_4(String nightExchangeTimes_4) {
        this.nightExchangeTimes_4 = nightExchangeTimes_4;
    }

    public String getNightExchangeTimes_5() {
        return this.nightExchangeTimes_5;
    }

    public void setNightExchangeTimes_5(String nightExchangeTimes_5) {
        this.nightExchangeTimes_5 = nightExchangeTimes_5;
    }
