...
public class Weather {
    ...
    public static Weather build(WeatherEntity entity) {
        ...
        dailies_1.exchangeTimes = new String[] {
                entity.dayExchangeTimes_1,
                entity.nightExchangeTimes_1};
        ...
        dailies_2.exchangeTimes = new String[] {
                entity.dayExchangeTimes_2,
                entity.nightExchangeTimes_2};
        ...
        dailies_3.exchangeTimes = new String[] {
                entity.dayExchangeTimes_3,
                entity.nightExchangeTimes_3};
        ...
        dailies_4.exchangeTimes = new String[] {
                entity.dayExchangeTimes_4,
                entity.nightExchangeTimes_4};
        ...
        dailies_5.exchangeTimes = new String[] {
                entity.dayExchangeTimes_5,
                entity.nightExchangeTimes_5};
    ...
    public static Weather build(Context c, JuheResult result) {
        ...
        for (int i = 0; i < DAILY_LENGTH; i ++) {
            if (i < result.result.data.weather.size()) {
                ...
                daily.exchangeTimes = new String[] {
                ...
                daily.exchangeTimes = new String[] {"null", "null"};
        ...
        for (int i = 0; i < HOURLY_LENGTH; i ++) {
            if (i < result.result.data.f3h.temperature.size()) {
                ...
                hourly.pop = Float.parseFloat(result.result.data.f3h.precipitation.get(i).jf);
    ...
    public static Weather build(Context c, HefengResult result) {
        ...
        for (int i = 0; i < DAILY_LENGTH; i ++) {
            if (i < result.heWeather.get(p).hourly_forecast.size()) {
                ...
                hourly.pop = Float.parseFloat(result.heWeather.get(p).hourly_forecast.get(i).pop);
        ...
        w.life.colds = new String[] {
                c.getString(R.string.cold_index),
                c.getString(R.string.feedback_no_data)};
        w.life.airs = new String[] {
                c.getString(R.string.aqi),
                c.getString(R.string.feedback_no_data)};
        w.life.washCars = new String[] {
                c.getString(R.string.wash_car_index),
                c.getString(R.string.feedback_no_data)};
        w.life.sports = new String[] {
                c.getString(R.string.exercise_index),
                c.getString(R.string.feedback_no_data)};
