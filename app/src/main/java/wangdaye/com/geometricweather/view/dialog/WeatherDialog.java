...
public class WeatherDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void initWidget(View view) {
        boolean isDay = TimeUtils.getInstance(getActivity()).getDayTime(getActivity(), weather, false).isDay;
        ...
        imageIds[0] = WeatherUtils.getWeatherIcon(
                WeatherUtils.getWeatherKind(weather.dailyList.get(position).weathers[0]),
                true);
        imageIds[1] = WeatherUtils.getWeatherIcon(
                WeatherUtils.getWeatherKind(weather.dailyList.get(position).weathers[1]),
                false);
        ...
        sunText[0].setText(weather.dailyList.get(position).exchangeTimes[0]);
        sunText[1].setText(weather.dailyList.get(position).exchangeTimes[1]);
        ...
        animatorIds[0] = WeatherUtils.getAnimatorId(
                WeatherUtils.getWeatherKind(weather.dailyList.get(position).weathers[0]),
                true);
        animatorIds[1] = WeatherUtils.getAnimatorId(
                WeatherUtils.getWeatherKind(weather.dailyList.get(position).weathers[1]),
                false);
